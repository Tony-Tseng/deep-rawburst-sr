...
class MergeBlockUNetDiff(nn.Module):
    def __init__(self, num_features, input_dim, project_dim, 
        ...
        weight_predictor = []
        weight_predictor.append(blocks.conv_block(num_features, 2 * project_dim, 3,
        ...
        self.conv2 = nn.Sequential(nn.Conv2d(input_dim, num_features, kernel_size=3, padding=1, bias=bias))
...
def dcnsrnet_unet_mergediff(alignment_init_dim, reduction, alignment_out_dim, dec_init_conv_dim, 
    ...
    fusion = MergeBlockUNetDiff(num_features=256, input_dim=64, project_dim=64)
