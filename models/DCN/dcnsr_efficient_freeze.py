...
class MergeBlockUNetDiff(nn.Module):
    def __init__(self, num_features, input_dim, project_dim, 
        ...
        # print(self.efficientnet_extractor)
        # self.efficientnet.stem = nn.Sequential()
        # self.efficientnet.classifier = nn.Sequential()
        # self.efficientnet_extractor = self.efficientnet.layers[:4]
        ...
        for param in self.efficientnet_extractor.parameters():
